...
<div class="paper">
  <div class="paper__body">
    <h3 class="paper__title">Exploring the Influence of Tribal Governance Capacity: Evidence from Internet Availability in Indian Country</h3>
    <p class="paper__cite">Brouwer, N. R. <em>Journal of Political Institutions and Political Economy</em> 5(2): 179&ndash;207 (2024).</p>
    <div class="paper__actions">
      <a href="/files/pdf/broadband_access_reservation_brouwer_2024.pdf" class="btn">Download</a>
      <a href="http://dx.doi.org/10.1561/113.00000098" class="btn">Journal link</a>
  ...
  <a class="paper__figure" href="/files/images/aibb_map_display.jpg">
    <img src="/files/images/aibb_map_display.jpg" alt="Map of cable internet availability across census blocks in Indian Country">
  </a>
</div>

<div class="paper">
  <div class="paper__body">
    <h3 class="paper__title">NIMBYs, YIMBYs, and the Politics of Land Use in American Cities</h3>
    <p class="paper__cite">Brouwer, N. R., and Jessica Trounstine. <em>Annual Review of Political Science</em> 27 (2024).</p>
    <div class="paper__actions">
      <a href="/files/pdf/nimby_yimby_annual_review_2024.pdf" class="btn">Download</a>
      <a href="https://doi.org/10.1146/annurev-polisci-041322-041133" class="btn">Journal link</a>
      <details class="paper__disclosure">
        <summary>Abstract</summary>
        <div class="paper__panel">
...
<div class="paper">
  ...
  <a class="paper__figure" href="/files/images/doi_distro_display.jpg">
    <img src="/files/images/doi_distro_display.jpg" alt="Distribution of Department of the Interior funding across tribal governments">
  </a>
</div>
